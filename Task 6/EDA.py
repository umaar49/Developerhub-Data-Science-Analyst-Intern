...
@st.cache_data
def load_data():
    # Path to the zipped dataset in your repo
    zip_path = "C:\\UMAR DATA\\Data Sciences\\Intership\\Task 1\\ezyZip.zip"

    # Unzip inside the dataset folder
    with zipfile.ZipFile(zip_path, 'r') as z:
        z.extractall("dataset")

    # Replace with the actual CSV filename inside your zip
    data = pd.read_csv("C:\\UMAR DATA\\Data Sciences\\Intership\\Task 1\\processed_retail_data.csv")
